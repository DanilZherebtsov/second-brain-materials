...
- **Собрать второй мозг под дело:** первым сообщением в проекте из конструктора — «Я занимаюсь <дело>. Собери мне под это второй мозг и наведи порядок» (Claude сам проведёт короткое интервью).
...
## Безопасность — 5 правил

- **Бэкап** перед первым запуском на важной папке.
...
- Claude Desktop установлен, подписка Pro активна, VSCode + Markdown All in One стоят.
